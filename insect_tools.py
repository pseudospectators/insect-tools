...
def load_t_file( fname, interp=False, time_out=None, return_header=False, verbose=True, time_mask_before=None ):
    ...
    Optionally, use time_mask_beforeto hide the first times: useful if there is a startup singularity.
    """
